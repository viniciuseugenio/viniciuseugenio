...
Meus melhores projetos estão fixados no perfil, então dê uma olhada neles, se sinta à vontade para rodá-los e compartilhar suas críticas comigo (pode esculachar, melhor ainda). Atualmente estou trabalhando no [Maison Senna](https://github.com/viniciuseugenio/maison-senna), um e-commerce full-stack feito com Django REST e React.js. Meus contatos estão na aba do perfil, caso queira se conectar comigo. Garanto que será uma boa conversa. Até logo! :)
